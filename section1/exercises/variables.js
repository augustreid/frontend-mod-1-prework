...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
// firstName is clearly supposed to store a name, which would be a string, since it is text and not a number or true/false.
// isHungry could be a question with a binary answer, so it is a boolean.
// numberOfPets specifies in the name that it is a number.
